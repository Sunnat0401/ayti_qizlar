...
//   return (
//     <nav className="sticky top-0 z-50 bg-white dark:bg-gray-900 shadow-md transition-colors duration-300 no-underline hover:no-underline ">
...
//               <img src={Logo} alt="no-underline hover:no-underline" />
//             </div>
...
//                   className={`block px-3 py-2 rounded-md text-base font-medium mb-1  no-underline hover:no-underline  ${
//                     location.pathname === item.path
//                       ? 'bg-primary-purple text-white'
//                       : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800'
//                   }`}
